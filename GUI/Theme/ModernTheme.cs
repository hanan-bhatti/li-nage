...
{
    /// <summary>
    /// Modern theme with VS Code Dark styling
    /// Colors can be modified via ThemeManager for custom themes
    /// </summary>
    public static class ModernTheme
    {
        // VS Code Dark Modern Palette - Editable via ThemeManager
        public static Color BackColor = Color.FromArgb(30, 30, 30);        // Editor Background #1E1E1E
        public static Color SurfaceColor = Color.FromArgb(37, 37, 38);     // Side Bar #252526
        public static Color SurfaceLight = Color.FromArgb(51, 51, 51);     // Hover/Selection #333333
        public static Color ActivityBarColor = Color.FromArgb(51, 51, 51); // Activity Bar Background #333333

        public static Color TextPrimary = Color.FromArgb(204, 204, 204);   // Primary Text #CCCCCC
        public static Color TextSecondary = Color.FromArgb(150, 150, 150); // Secondary Text #969696
        public static Color TextDisabled = Color.FromArgb(100, 100, 100);  // Disabled Text #646464
        
        public static Color PrimaryColor = Color.FromArgb(0, 122, 204);    // VS Code Blue #007ACC
        public static Color PrimaryDark = Color.FromArgb(0, 90, 158);      // Darker Blue #005A9E
        public static Color StatusBarColor = Color.FromArgb(0, 122, 204);  // Status Bar Blue
        
        public static Color ErrorColor = Color.FromArgb(244, 135, 113);    // Error Red #F48771
        public static Color SuccessColor = Color.FromArgb(137, 209, 133);  // Success Green #89D185
        public static Color WarningColor = Color.FromArgb(204, 167, 0);    // Warning Yellow #CCA700

        public static Color BorderColor = Color.FromArgb(64, 64, 64);      // Borders #404040
        public static Color SplitterColor = Color.FromArgb(45, 45, 45);    // Splitter #2D2D2D

        // Tabs
        public static Color TabActive = Color.FromArgb(30, 30, 30);        // Match BackColor #1E1E1E
        public static Color TabInactive = Color.FromArgb(45, 45, 45);      // Inactive Tab #2D2D2D
        public static Color TabHover = Color.FromArgb(40, 40, 40);         // Tab Hover #282828
